...
This page lists a number of **ideas** for potential projects to be carried out by the persons participating in Google Summer of Code 2026.
...
Successful pull requests increase the chance of being accepted as a mentee.
...
There can be an initial phase to evluate whether PostgreSQL is the right DBMS as backend for JabRef. For instance, DuckDB and SQLite were also discussed. Currently, PostgeSQL turned out best (especially for handling regular expression search on the database itself), but things may have changed in 2026.
...
You can propose other projects. JabRef offers various places where it can be improved.
Think as a user or talk to other users.
The following places are a good start:
...
- Issues tagged with GSoC: <https://github.com/JabRef/jabref/issues?q=sort%3Aupdated-desc+state%3Aopen+label%3A%22project%3A+gsoc%22>
