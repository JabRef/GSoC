...
See JabRef's [AI_USAGE_POLICY.md](https://github.com/JabRef/jabref/blob/main/AI_USAGE_POLICY.md) for the expectations we have from candidates regarding AI usage.
We only consider candidates who can think and take decisions organically, in spirit of Software Engineering as a holistic process and not just "programming". Thus, interested candidates are expected to adhere to the policy.
